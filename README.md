...
🚀 [Open SignalScope on Streamlit](https://compose-c3hiklxb6rnj8wf8rh7i3u.streamlit.app/)
...
🚀 [SignalScopeをStreamlitで起動](https://compose-c3hiklxb6rnj8wf8rh7i3u.streamlit.app/)
...
The signals generated by this application do not constitute financial or investment advice.
Investment decisions should be made at your own risk.

## ⚠️ 免責事項

本アプリは学習・情報提供を目的として作成したものです。
表示される買い・売り判定は、投資助言や投資勧誘を目的とするものではありません。
実際の投資判断は、ご自身の責任で行ってください。
